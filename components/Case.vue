    ...
    const showDateTime = (singleCase) => new Date(singleCase?.attributes?.updatedAt).toDateString() + " | " + new Date(singleCase?.attributes?.updatedAt).toLocaleTimeString();
    </script>
    <template>
       <!--  <li class="post">
            ...
            <div class="comment-cont">
                ...
                <form class="comment-form">
                    <div class="form-control">
                        <textarea name="comment" id="comment" cols="30" rows="1" class="form-textarea comment-textarea"
